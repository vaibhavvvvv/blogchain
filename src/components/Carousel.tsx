...
const Carousel = () => {
  return (
    <div>
      <div className="p-16 sm:p-24 lg:p-48 bg-black">
        
        <div className="relative rounded-lg block md:flex items-center bg-gray-800 shadow-xl" style={{ minHeight:"19rem"}}>
          <div className="relative w-full md:w-2/5 h-full overflow-hidden rounded-t-lg md:rounded-t-none md:rounded-l-lg" style={{minHeight: "19rem"}}>
            ...
            <div className="absolute inset-0 w-full h-full bg-teal-900 opacity-75"></div>
          ...
          <div className="w-full md:w-3/5 h-full flex items-center bg-gray-800 rounded-lg">
            <div className="p-12 md:pr-24 md:pl-16 md:py-12">
              ...
              <a className="flex items-baseline mt-3 text-teal-600 hover:text-teal-900 focus:text-teal-900" href="">
                <span>Learn more about our users</span>
                <span className="text-xs ml-1">&#x279c;</span>
              </a>
            </div>
            <svg className="hidden md:block absolute inset-y-0 h-full w-24 fill-current text-gray-800 -ml-12" viewBox="0 0 100 100" preserveAspectRatio="none">
              <polygon points="50,0 100,0 50,100 0,100" />
            </svg>
          </div>
          <button className="absolute top-0 mt-32 left-0 bg-white rounded-full shadow-md h-12 w-12 text-2xl text-teal-600 hover:text-teal-400 focus:text-teal-400 -ml-6 focus:outline-none focus:shadow-outline">
            <span className="block" style={{transform: "scale(-1)"}}>&#x279c;</span>
          </button>
          <button className="absolute top-0 mt-32 right-0 bg-white rounded-full shadow-md h-12 w-12 text-2xl text-teal-600 hover:text-teal-400 focus:text-teal-400 -mr-6 focus:outline-none focus:shadow-outline">
            <span className="block" style={{transform: "scale(1)"}}>&#x279c;</span>
          </button>
        </div>
