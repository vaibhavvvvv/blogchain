...
<h1 className="w-full md:w-4/5 hover:text-blue-200">Express Your Experiences
...
<Link href="/create" className="bg-red-500 hover:bg-red-700 hover:shadow-md hover:shadow-red-400 justify-center text-center rounded-lg shadow px-10 py-3 flex items-center">Create A New Blog</Link>
